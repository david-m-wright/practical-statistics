...
Before continuing, download the following files from Canvas and put them in your `code` folder:

1.  `quarto-example.qmd`

Download the following files from Canvas and put in your `data` folder:
...
```{r}
ggsave(filename = here("high-res-covid-plot.tiff"),
  width = 5,
  height = 5,
  plot = covid_plot, 
  dpi = 300)
